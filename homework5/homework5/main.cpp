...
#include <vector>
#include <fstream>
#include "/Users/jzhou/Downloads/newmat11/newmatap.h"
#include "/Users/jzhou/Downloads/newmat11/newmat.h"
#include "/Users/jzhou/Downloads/newmat11/newmatio.h"
    ...
    
    {
        ...
        do
        {
            ...
            if (Rank(Column_reduced_version_of_A) == rank_of_A)
            {
                ...
                // column of A that was noåt picked...
                ...
                for (int k = 0; k < A.nrows(); ++k){
                    if (did_i_pick_this_col[k] == true){
                        temp.push_back(soln(nsoln));
                        nsoln++;
                    }
                    else{
                        temp.push_back(0);
