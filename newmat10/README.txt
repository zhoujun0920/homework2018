ReadMe file for newmat10E - release version - 22 December, 2016
------------------------------------------------------------
...
Version 10E corrects an incompatibility with the C++ standard "you
cannot throw an exception from a destructor". See documentation
section 3.4 "entering values" for a slight change in the syntax.
